...
//      Solution S;
      ...
      /*Soluti*//*on s = new Solution(I);
      s.construitListe();

        System.out.println("Une solution \n");

      System.out.println("Numero    " + s.getChoisis().affichelNum());
      System.out.println("Poids     " + s.getChoisis().affichelPoids());
      System.out.println("Utilites  " + s.getChoisis().affichelUtil());

      System.out.println("Utilite totale   " + s.getChoisis().getUtilTotale());
      System.out.println("Poids totale     " + s.getChoisis().getPoidsTotal());*/


      ProgrammationDynamique programmationDynamique = new ProgrammationDynamique(I);

//        System.out.println(programmationDynamique.calculSolution());
programmationDynamique.tableau();
